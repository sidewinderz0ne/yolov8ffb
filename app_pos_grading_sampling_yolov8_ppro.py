...
class Frame1(tk.Frame):
    ...
    def refresh_data(self):
        ...
        for data in record:
            ...
            arrData.append(( WBTicketNo, VehiclePoliceNO, DriverName, BUnit, Divisi, Field,Bunches, Ownership, push_time ))
    ...
    def run_script(self, row_item, row_id, row_values):
        ...
        try:
            ...
            subprocess.run(['python', '8-track-batas_2.py', '--pull_data', str(row_values)], check=True)
