...
parser.add_argument("--cctv", type=str, default='main', help="Enable debug mode to store everything printed result into txt file")
...
path_cctv_log = Path(os.getcwd() + '/hasil/' + formatted_date + '/'+ no_tiket + '/result_' + cctv_source + '.TXT')
