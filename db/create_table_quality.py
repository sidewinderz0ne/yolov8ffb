...
#     insert_query = '''
#     INSERT INTO quality (AI_NoTicket, AI_JanjangSample, AI_TotalJanjang, AI_Grading, AI_Janjang, AI_push_time, Ppro_pull_time)
#     VALUES (?, ?, ?, ?, ?, ?, ?)
#     '''
#     sqlite_cursor.execute(insert_query, (
#         record['AI_NoTicket'], record['AI_JanjangSample'], record['AI_TotalJanjang'],
#         record['AI_Grading'],record['AI_Janjang'], record['AI_push_time'], record['Ppro_pull_time']
#     ))
