...
param1_value = 'total'
cctvMain_ip = '10.9.116.177'
cctv2_ip = '10.9.116.178'
cctv3_ip = '10.9.116.179'

program1_command = ['python', '9-track-new-pov.py', '--mode', param1_value, '--cctv', cctvMain_ip, '--tiket', no_tiket, '--source' ,'10.9.116.177']
program2_command = ['python', 'opencv_cctv.py', '--source', cctv2_ip, '--tiket',no_tiket]
program3_command = ['python', 'opencv_cctv.py', '--source', cctv3_ip, '--tiket',no_tiket]
...
try:
    ...
    def calculate_average_for_key(key):
        values_for_key = [
            ...
            for cctv_ip in [cctvMain_ip, cctv2_ip, cctv3_ip]
        ]
